...
public interface CardRepository extends JpaRepository<Card, Long> {
    ...
    String SELECT_CARD_BY_ID_TRELLO_AND_ID_LABEL = "SELECT card.id, card.id_trello, card.name, card.position, card.description, card.expiration_date, card.date_last_activity, " +
